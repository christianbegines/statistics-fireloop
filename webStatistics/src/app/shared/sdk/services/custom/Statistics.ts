...
/**
 * Api services for the `Statistics` model.
 */
@Injectable()
export class StatisticsApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for Statistics registers.
   *
